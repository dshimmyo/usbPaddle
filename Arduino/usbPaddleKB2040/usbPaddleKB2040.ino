...
Adafruit_NeoPixel pixel(1, PIN_NEOPIXEL, NEO_GRB + KHZ800);
...
uint8_t const desc_hid_report[] = { 
  // --- COLLECTION 1: STANDARD (Anbernic/Mac) ---
  0x05, 0x01, 0x09, 0x05, 0xa1, 0x01, 0x85, 0x01, 0x09, 0x01, 0xa1, 0x00,
  0x05, 0x01, 0x09, 0x30, 0x09, 0x31, 0x15, 0x81, 0x25, 0x7f, 0x75, 0x08, 0x95, 0x02, 0x81, 0x02, 0xc0,
  ...
  // --- COLLECTION 2: XINPUT (Spoofing Xbox 360) ---
  // Simplified Gamepad mapping X-axis to Left Stick X
  0x05, 0x01, 0x09, 0x05, 0xa1, 0x01, 0x85, 0x03, 
  0x09, 0x01, 0xa1, 0x00, 0x09, 0x30, 0x15, 0x81, 0x25, 0x7f, 0x75, 0x08, 0x95, 0x01, 0x81, 0x02, 0xc0,
  0x05, 0x09, 0x19, 0x01, 0x29, 0x0a, 0x15, 0x00, 0x25, 0x01, 0x75, 0x01, 0x95, 0x0a, 0x81, 0x02, 
  0x75, 0x06, 0x95, 0x01, 0x81, 0x01, 0xc0,

  // --- COLLECTION 3: PS4 (Spoofing DualShock 4) ---
...
enum { MODE_STANDARD, MODE_XINPUT, MODE_PS4 };
